...
export default {
  ...
  methods: {
    ...
    set_graphics_pie() {
      ...
      let temp = [];
      for (let i = 0; i < this.lists[this.year]; i++) {
        console.log("99", Number(this.lists[this.year][i].month));
        ...
        temp = ["sss"];
        console.log("temp 00", Number(this.lists[this.year][i].month), Number(this.month));
        return;
      }
      // this.lists[this.year].forEach((i) => {
      //   temp = Number(i.month) == Number(this.month) ? i : ["sss"];
      //   console.log("temp 00", Number(i.month), Number(this.month));
      //   return;
      // });
