        ...
        series: [
          {
            ...
            radius: "50%",
            data: [
              { value: this.lists[this.year][this.month - 1].realSalary, name: this.$t("realSalary") },
              { value: this.lists[this.year][this.month - 1].rent, name: this.$t("rent") },
              { value: this.lists[this.year][this.month - 1].utilities, name: this.$t("utilities") },
              { value: this.lists[this.year][this.month - 1].shop, name: this.$t("shop") },
              { value: this.lists[this.year][this.month - 1].deposit, name: this.$t("deposit") },
            ],
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
