...
export default {
  ...
  methods: {
    ...
    click_delete(item, index) {
      this.$confirm(this.$t("delete"), "提示", { confirmButtonText: this.$t("btn.sure"), cancelButtonText: this.$t("btn.cancel"), cancelButtonClass: "infoBoxCancel", customClass: "infoBox", type: "warning" })
        .then(() => {
          this.axios
