<template>
  <div class="table">
    <el-button @click="click_add" size="mini" type="primary">{{ $t("btn.add") }}</el-button>
    <el-form>
      <el-table ref="table" :data="lists[year]">
        ...
        <el-table-column prop="action" :label="$t('action')">
          <template v-slot="scope">
            <template v-if="scope.row.action == 'view'">
              <el-button class="edit" @click="click_edit(scope.row, scope.$index)" size="mini">
                <i class="iconfont icon-17"></i>
              </el-button>
              <el-button class="edit" @click="click_delete(scope.row, scope.$index)" size="mini">
                <i class="iconfont icon-shanchu1"></i>
              </el-button>
            </template>
            <template v-else>
              <el-button class="save" size="mini" type="primary" @click="click_save(scope.row, scope.$index)">{{ $t("btn.save") }}</el-button>
              <el-button class="save" size="mini" type="primary" @click="click_cancle(scope.row, scope.$index)">{{ $t("btn.cancle") }}</el-button>
            </template>
          </template>
        </el-table-column>
      </el-table>
