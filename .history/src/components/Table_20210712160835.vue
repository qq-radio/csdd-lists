...
export default {
  ...
  methods: {
    ...
    click_delete(item, index) {
      this.$confirm(this.$t("confirm.delete"), this.$t("confirm.hint"), { confirmButtonText: this.$t("btn.sure"), cancelButtonText: this.$t("btn.cancel"), cancelButtonClass: "infoBoxCancel", customClass: "infoBox", type: "warning" })
        .then(() => {
          this.axios
