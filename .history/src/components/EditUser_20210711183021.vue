<template>
  <div class="editUser">
    <div class="head">
      <el-button @click="$router.push({ name: 'home' })" type="medium">{{ $t("btn.back") }}</el-button>
    </div>
    ...
    <el-form v-if="activeStep == '1'" :model="form_1" ref="refForm_1" :rules="rules_1" label-position="left">
      ...
      <el-form-item class="login">
        <el-button @click="click_step_1" type="primary" type="medium">{{ $t("btn.next_step") }}</el-button>
      </el-form-item>
    </el-form>
    ...
    <div v-if="activeStep == '3'" class="sure">
      ...
      <el-button @click="$router.push({ name: 'home' })" type="primary">{{ $t("btn.sure") }}</el-button>
    </div>
  </div>
</template>
