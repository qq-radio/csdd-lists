...
export default {
  ...
  methods: {
    ...
    set_graphics_pie() {
      console.log("set------pie");
      console.log("7777", this.lists[this.year][this.month - 1]);
        ...
        series: [
          {
            ...
            radius: "50%",
            data: [
              { value: this.lists[this.year][this.month].realSalary || 0, name: this.$t("realSalary") },
              { value: this.lists[this.year][this.month].rent || 0, name: this.$t("rent") },
              { value: this.lists[this.year][this.month].utilities || 0, name: this.$t("utilities") },
              { value: this.lists[this.year][this.month].shop || 0, name: this.$t("shop") },
              { value: this.lists[this.year][this.month].deposit || 0, name: this.$t("deposit") },
            ],
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
