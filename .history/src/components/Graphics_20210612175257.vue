...
export default {
  ...
  methods: {
    ...
    get_datas() {
      console.log("555", sessionStorage.hasOwnProperty("year"), localStorage.hasOwnProperty(sessionStorage.hasOwnProperty("year")));

      if (localStorage.hasOwnProperty(sessionStorage.getItem("year")) == false) {
