...
export default {
          ...
          this.axios
            ...
            .then((res) => {
              ...
              if (res.data.status == 200) {
                this.get_datas({ year: this.year }).then(this.$message({ message: "添加成功", type: "info", customClass: "info" }));
                // this.lists.splice(0,index)
        ...
        case "edit":
          ...
          this.axios
            ...
            .then((res) => {
              ...
              if (res.data.status == 200) {
                this.get_datas({ year: this.year }).then(this.$message({ message: "编辑成功", type: "info", customClass: "info" }));
              }
            })
            .catch(function (err) {});
          break;
  ...
  mounted() {
    ...
    let arr = [1, 8, 4, 9, 100000000000000000000, 17];
    console.log("yyy", arr.splice(0, 4, 1), "999 ------------", arr);
  },
};
</script>
