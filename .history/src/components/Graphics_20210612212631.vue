<template>
  <div class="graphics">
    ...
    <el-select v-model="month" v-show="show.one">
...
export default {
  ...
  methods: {
    ...
    click_one() {
      ...
      this.show.two = false;
      set_graphics_1();
      sessionStorage.setItem("graphics", "line");
    },
    ...
    click_two() {
      ...
      show.two = true;
      set_graphics_2();
      sessionStorage.setItem("graphics", "pie");
    },
  ...
  mounted() {
    ...
    if (sessionStorage.hasOwnProperty("graphics") == false) {
      ...
      this.show.active = sessionStorage.getItem("graphics");
    }
    this.get_datas();
  },
};
