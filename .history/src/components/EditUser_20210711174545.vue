<template>
  <div class="editUser">
    ...
    <el-form v-if="activeStep == '2'" :model="form_2" ref="refForm_2" :rules="rules_2" label-position="left">
      <el-form-item :label="$t('editUser.new_password')" prop="new_password" label-width="140px">
        <el-input v-model="form_2.new_password"></el-input>
      </el-form-item>
      <el-form-item :label="$t('editUser.new_password_again')" prop="new_password_again" label-width="140px">
