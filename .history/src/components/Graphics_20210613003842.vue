<template>
  <div class="graphics">
    <el-radio-group v-model="show.active">
      <el-radio-button label="line" @click="click_one"> {{ $t("graphics.line") }} </el-radio-button>
      <el-radio-button label="pie" @click="click_two"> {{ $t("graphics.pie") }} </el-radio-button>
    </el-radio-group>
    <div class="desc">
      {{ desc }}
    </div>
...
export default {
  ...
  methods: {
    ...
    get_datas() {
      ...
      console.log("lists ------", this.lists[this.year]);
      console.log("this.show.active", this.show.active == "line");
      this.show.active == "line" ? this.set_graphics_line() : this.set_graphics_line();
      // switch (this.show.active) {
      //   case "line":
      //     console.log("111");
      //     this.set_graphics_line();
