<template>
  <div class="graphics" v-loading="loading" element-loading-text="Loading..." element-loading-spinner="el-icon-loading">
    <div style="background-color: gray; height: 70vh; width: 100vh"></div>
    <div class="wrapper">
      <div id="one"></div>
    </div>
  </div>
