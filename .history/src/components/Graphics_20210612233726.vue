<template>
  <div class="graphics">
    <el-radio-group v-model="show.active">
      <el-radio-button label="line" @click="click_one"> 折线图 </el-radio-button>
      <el-radio-button label="pie" @click="click_two"> 饼图 </el-radio-button>
    </el-radio-group>
    <div class="desc">
      {{ desc }}
    </div>
...
export default {
  ...
  methods: {
    ...
    set_graphics_1() {
      this.desc = " this is set_graphics_1";
    ...
    set_graphics_2() {
      this.desc = " this is set_graphics_22222222";
        ...
        series: [
          {
            ...
            radius: "50%",
            data: [
              { value: this.lists[this.year].realSalary, name: this.$t("realSalary") },
              { value: this.lists[this.year].rent, name: this.$t("rent") },
              { value: this.lists[this.year].utilities, name: this.$t("utilities") },
              { value: this.lists[this.year].shop, name: this.$t("shop") },
              { value: this.lists[this.year].deposit, name: this.$t("deposit") },
            ],
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
