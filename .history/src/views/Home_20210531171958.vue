      ...
      <el-table :data="form.datas" highlight-current-row style="width: 100%">
        ...
        <el-table-column prop="realSalary" label="工资到手">
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.realSalary'" required='true'  >
                <el-input  size="mini" v-model.trim="scope.row.realSalary" style="width: 120px;" @change="value=value.replace(/[^d]/g,'')"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
