          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.realSalary'" :rules="form.rule">
                <el-input size="mini" v-model.trim="scope.row.realSalary" style="width: 120px" @change="handleChange(0,scope.row.realSalary)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.rent'" :rules="form.rule">
                <el-input size="mini" v-model.number="scope.row.rent" style="width: 120px" @change="handleChange(1,scope.row.rent)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.utilities'" :rules="form.rule">
                <el-input size="mini" v-model.trim="scope.row.utilities" style="width: 120px"  @change="handleChange(2,scope.row.utilities)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.shop'" :rules="form.rule">
                <el-input size="mini" v-model.trim="scope.row.shop" style="width: 120px"  @change="handleChange(3,scope.row.shop)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
