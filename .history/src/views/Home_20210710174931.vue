    ...
    <div class="head">
      ...
      <div class="right">
        ...
        <el-select v-model="year" @change="set_year">
          <el-option v-for="i in yearArr[$i18n.locale]" :key="i.value" :label="i.label" :value="i.value"> </el-option>
        </el-select>
        <i class="iconfont icon-nian"></i>
      </div>
    </div>
    <el-tabs v-model="activeTab" type="border-card" @tab-click="set_activeTab">
