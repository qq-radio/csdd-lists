...
export default {
  ...
  methods: {
    ...
    clickTab(tab, event) {
      ...
      // if (tab.index == 1) {
      //   this.$router.push({ name: "graphics" });
      //   localStorage.setItem("activeTab", JSON.stringify("graphics"));
      // }
      // if (tab.index == 2) {
      //   this.$router.push({ name: "more" });
      //   localStorage.setItem("activeTab", JSON.stringify("more"));
      // }
      switch (tab.index) {
        case 0:
          this.activeTab = "home";
  ...
  mounted() {
    // this.set_datas();
    console.log('sessionStorage.hasOwnProperty("activeTab")');
