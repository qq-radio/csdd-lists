  ...
  <div class="home">
    ...
    <el-tabs v-model="activeTab" type="border-card" @tab-click="clickTab">
      <el-tab-pane label="表格" name="first">
        ...
        <el-form :model="form">
          <el-table :data="lists[year]" :default-sort="{ prop: 'month', order: 'descending' }" ref="table" highlight-current-row style="width: 100%" stripe>
...
export default {
  ...
  methods: {
    ...
    click_sort() {
      ...
      this.$refs.table.sort("month", "ascending");
    },
