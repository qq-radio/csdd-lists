    ...
    <div class="head">
      <div class="left">
        ...
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu style="display: flex" class="test">
              <el-dropdown-item class="test" style="color: red; padding: 0">Bright</el-dropdown-item>
              <el-dropdown-item class="test">Warm</el-dropdown-item>
