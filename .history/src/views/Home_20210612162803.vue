...
export default {
  ...
  methods: {
    ...
    get_datas() {
      console.log("localStorage.hasOwnProperty(this.year) == false", localStorage.hasOwnProperty(this.year));
  ...
  created() {},
  mounted() {
    if (localStorage.hasOwnProperty("2019") && localStorage.hasOwnProperty("2020") && localStorage.hasOwnProperty("2021")) {
      init().then((res) => {
        if (res) {
