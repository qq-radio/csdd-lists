      ...
      <el-table :data="form.datas" highlight-current-row style="width: 100%">
        ...
        <el-table-column prop="realSalary" label="工资到手">
          <template v-slot="scope">
            ...
            <template v-else >
              <el-form-item ref='form' :prop="'datas.' + scope.$index + '.realSalary'" >
                <el-input size="mini" v-model.trim="scope.row.realSalary" style="width: 120px" :rules="form.realSalary"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="rent" label="房租">
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.rent'" :rules="rules.realSalary">
...
export default {
  ...
  methods: {
    validateField() {
      ...
      //   this.$refs["form"]
      //     .validateField(this.form.datas[1])
      //     .then((res) => {
      //       resolve(res);
      //     })
      //     .catch((err) => {
