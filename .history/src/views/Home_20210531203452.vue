      ...
      <el-table :data="form.datas" highlight-current-row style="width: 100%">
        ...
        <el-table-column prop="realSalary" label="工资到手">
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item ref='test' :prop="'datas.' + scope.$index + '.realSalary'"  :rules="form.rules.realSalary">
...
var checkAge = (rule, value, callback) => {
  console.log("111", value.match(/^[0-9]*$/g));
  if (!value) {
    return callback(new Error("不能为空！！"));
  } else if (!value.match(/^[0-9]*$/g)) {
    console.log("!Number.isInteger(value)", value.match(/^[0-9]*$/g));
    ...
    return {
      ...
      form: {
        ...
        rules: {
          ...
          rent: [{ validator: rule_1, trigger: "blur" }],
          utilities: [{ validator: rule_1, trigger: "blur" }],
          shop: [{ validator: rule_1, trigger: "blur" }],
        },
      },
      itemClone: {},
    };
