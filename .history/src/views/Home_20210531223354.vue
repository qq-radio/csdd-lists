      ...
      <el-table :data="form.datas" highlight-current-row style="width: 100%">
        ...
        <el-table-column prop="rent" label="房租">
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.rent'" :rules="rules.rent">
...
export default {
  ...
  methods: {
    validateField() {
      console.log("00000", this.$refs["form"]);
      console.log("1111", this.$refs["form"].validateField.prop);
      ...
      for (let item of this.$refs['form'].validateField) {
