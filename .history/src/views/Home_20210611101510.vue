  ...
  <div class="home">
    <div class="head">
      <div class="left">
        ...
        <span class="iconfont icon-zhongwen" @click="$i18n.locale = 'en'" v-if="$i18n.locale == 'cn'"></span>
        <span class="iconfont icon-yingwen" @click="$i18n.locale = 'cn'" v-if="$i18n.locale == 'en'"></span>
        <el-dropdown>
          <span class="iconfont icon-theme-palette-fill"></span>
          <template #dropdown>
            <el-dropdown-menu style="display: flex; padding: 0; border-radius: 4px" @click="click_theme">
              <el-dropdown-item style="color: rgb(135, 137, 138); background-color: rgb(223, 236, 242)">Bright</el-dropdown-item>
              <el-dropdown-item style="color: rgb(135, 137, 138); background-color: rgb(250, 226, 218)">Warm</el-dropdown-item>
              <el-dropdown-item style="color: rgb(135, 137, 138); background-color: rgb(38, 38, 38)">Dark</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
