  ...
  <div class="home">
    <div class="head">
      <div class="left">
        ...
        <el-tooltip class="item" effect="dark" content="goto to csdd blog" placement="bottom">
          <a href="https://github.com/csdd-21" target="_blank"><i class="iconfont icon-blog"></i></a>
        </el-tooltip>
      </div>
      <div class="right">
    ...
    <el-tabs v-model="activeTab" type="border-card" :before-leave="handle_beforeLeave">
