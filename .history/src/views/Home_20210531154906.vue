...
export default {
  ...
  methods: {
    ...
    click_add(item, index) {
      console.log("1111111-1", JSON.parse(JSON.stringify(this.form.datas)));
...
console.log("1111111-2", JSON.parse(JSON.stringify(this.form.datas)));
      this.$nextTick(() => {
        this.form.data.action = "add";
        this.form.datas[0] = this.form.data;
        // this.$set(this.form.datas, 0, this.form.data);
      });

      localStorage.setItem("costs", JSON.stringify(this.form.datas));
      console.log("1111111-3", JSON.parse(JSON.stringify(this.form.datas)));
    },
