          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.realSalary'" :rules="form.rule">
                <el-input size="mini" v-model.trim="scope.row.realSalary" style="width: 120px" @change="change_1(scope.row.realSalary)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
          ...
          <template v-slot="scope">
            ...
            <template v-else>
              <el-form-item :prop="'datas.' + scope.$index + '.rent'" :rules="form.rule">
                <el-input size="mini" v-model.number="scope.row.rent" style="width: 60px" @change="change_2(scope.row.rent)"></el-input>
              </el-form-item>
            </template>
          </template>
        </el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      itemClone: {},
      ruleArr: [true, true, true,true,true,true],
    };
  },
  watch: {},
  methods: {
