...
export default {
  ...
  methods: {
    ...
    change_language() {
      ...
      console.log("this.$i18n.locale", JSON.stringify(this.$i18n.locale));
    ...
    set_language() {
      if (sessionStorage.hasOwnProperty("language") == false) {
        ...
        console.log('JSON.parse(sessionStorage.getItem("language"))', JSON.parse(sessionStorage.getItem("language")));
      }
    },
  },
  created() {},
