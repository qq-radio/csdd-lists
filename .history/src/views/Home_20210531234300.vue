<template>
  <div class="home">
    ...
    <el-form :model="test.data" ref="form" :rules="test.rule">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        rules: {
          realSalary: [{ validator: rule, trigger: "blur" }],
        },
      },
      itemClone: {},
    };
  ...
  methods: {
    validateField(item, index) {
      console.log('ddd',this.$refs['form'].validateField());
      
      this.$refs['form'].validateField((i,j)=>{
        console.log('i,j',i,j),'realSalary'
