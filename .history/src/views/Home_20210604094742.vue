<template>
  <div class="home">
    ...
    <el-tabs v-model="activeTab" type="border-card" @tab-click="clickTab" v-loading="loading" element-loading-text="Loading..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
