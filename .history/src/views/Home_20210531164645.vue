<template>
  <div class="home">
    ...
    <el-form :model="form" :rules="form.rules">
      <el-table :data="form.data" highlight-current-row style="width: 100%">
        <el-table-column prop="date" label="日期" width="60"></el-table-column>

        <el-table-column prop="realSalary" label="工资到手">
            <el-form-item prop="realSalary">
              <el-input size="mini" v-model.trim="realSalary" style="width: 120px"></el-input>
            </el-form-item>
        </el-table-column>
        ...
        <el-table-column prop="rent" label="房租">
            ...
            <el-form-item :prop="rent">
              <el-input size="mini" v-model.number="rent" style="width: 120px"></el-input>
            </el-form-item>
