<template>
<div id="app">
    <h3>vue+ElementUI的简单消费清单系统，端口9099，采用window.localStorage本地存储</h3>
    <p>2020</p>
...
name:'Home',
    ...
    methods: {
        ...
        getData() {
            if (window.localStorage.hasOwnProperty("testAAA") == null) {
                let obj = [{
                    "realSalary": "",
                    "rent": "",
                    "utilities": "",
                ...
                console.log("dfsd")
                window.localStorage.setItem(JSON.stringify("testAAA"), JSON.stringify(obj))

            }


            let temp = JSON.parse(window.localStorage.getItem(JSON.stringify("testAAA")))
...
console.log('temp',temp);
        ...
        click_add(item, index) {
            ...
            window.localStorage.setItem(JSON.stringify("testAAA"), JSON.stringify(temp))
