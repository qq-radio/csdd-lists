        ...
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu style="display: flex; padding: 0; border-radius: 4px">
              ...
              <el-dropdown-item style="color: rgb(135, 137, 138); background-color: rgb(38, 38, 38)" @click="click_theme(2)">Dark</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    click_theme(i) {
      ...
      switch (i) {
        case 0:
          document.getElementsByClassName("home")[0].className = "themeBright";
          console.log("jjjj222", document.getElementsByClassName("home"));
          break;
        case 1:
          document.getElementsByClassName("home")[0].className = " themeWarm";
          console.log("jjjj222", document.getElementsByClassName("home"));
          break;
        case 2:
          document.getElementsByClassName("home")[0].className = " themeDark";
          console.log("jjjj222", document.getElementsByClassName("home"));
          break;
      }
    },
