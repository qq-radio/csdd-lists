<template>
  <div class="home">
    <div class="head">
      ...
      <el-select v-model="year" @change="changeYear(i)">
    ...
    <el-tabs v-model="activeTab" type="border-card" @tab-click="clickTab">
      <el-tab-pane label="表格" name="first">
        ...
        <el-form :model="form">
          <el-table :data="lists[year]" :default-sort="{ prop: 'month', order: 'descending' }" highlight-current-row style="width: 100%" stripe>
