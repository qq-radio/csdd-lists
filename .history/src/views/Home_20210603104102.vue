<template>
  <div class="home">
    ...
    <el-tabs v-model="activeTab" type="border-card" @tab-click="clickTab">
      <el-tab-pane label="表格" name="home">
      ...
      <el-tab-pane label="趋势图" name="graphics">
...
export default {
  ...
  methods: {
    ...
    set_datas() {
      this.axios
        ...
        .then((res) => {
          ...
          this.SET_LISTS({ year: "2019", lists: res.data["2019"] });
        })
        .catch(function (err) {})
        .then(function () {});
      ...
      this.axios
        ...
        .then((res) => {
          ...
          this.SET_LISTS({ year: "2020", lists: res.data["2020"] });
        })
        .catch(function (err) {})
        .then(function () {});
      ...
      this.axios
        ...
        .then((res) => {
          ...
          this.SET_LISTS({ year: "2021", lists: res.data["2021"] });
        })
        .catch(function (err) {
          console.log("err", err);
        })
    ...
    get_datas() {
      ...
      this.SET_LISTS({ year: this.year, lists: JSON.parse(localStorage.getItem(this.year)) });
      this.set_monthArr();
    },
