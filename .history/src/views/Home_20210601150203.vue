<template>
  <div class="home">
    ...
    <el-button size="mini" @click="click_more">新增</el-button>
            ...
            <el-table-column prop="operation" label="操作">
              <template v-slot="scope">
                ...
                <template v-else-if="scope.row.action == 'add'">
                  <el-button size="mini" @click="click_add_save(scope.row, scope.$index)">保存1</el-button>
                  <el-button size="mini" @click="click_add_cancle(scope.row, scope.$index)">取消1</el-button>
                </template>
                <template v-else>
                  <el-button size="mini" @click="click_save(scope.row, scope.$index)">保存2</el-button>
                  <el-button size="mini" @click="click_cancle(scope.row, scope.$index)">取消2</el-button>
                </template>
              </template>
            </el-table-column>
          </el-table>
