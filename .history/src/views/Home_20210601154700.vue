              ...
              <template v-slot="scope">
                ...
                <template v-else>
                  <el-form-item :prop="'datas.' + scope.$index + '.realSalary'" :rules="form.rule">
                    <el-input size="mini" :key="new Date()" v-model.trim="scope.row.realSalary" style="width: 120px" @change="change(0, scope.row.realSalary)"></el-input>
                  </el-form-item>
                </template>
              </template>
            </el-table-column>
              ...
              <template v-slot="scope">
                ...
                <template v-else>
                  <el-form-item :prop="'datas.' + scope.$index + '.rent'" :rules="form.rule">
                    <el-input size="mini" :key="new Date()" v-model.number="scope.row.rent" style="width: 120px" @change="change(1, scope.row.rent)"></el-input>
                  </el-form-item>
                </template>
              </template>
            </el-table-column>
              ...
              <template v-slot="scope">
                ...
                <template v-else>
                  <el-form-item :prop="'datas.' + scope.$index + '.utilities'" :rules="form.rule">
                    <el-input size="mini" :key="new Date()" v-model.trim="scope.row.utilities" style="width: 120px" @change="change(2, scope.row.utilities)"></el-input>
                  </el-form-item>
                </template>
              </template>
            </el-table-column>
