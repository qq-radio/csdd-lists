<template>
  <div class="home">
    ...
    <el-tabs :style="loading ? { overflow: 'hidden' } : ''" v-model="activeTab" type="border-card" @tab-click="clickTab" v-loading="loading" element-loading-text="Loading..." element-loading-spinner="el-icon-loading">
